                                ...
                                @if (count($components) > 0)
                                    ...
                                    <tbody>
                                        <tr>
                                            ...
                                            <x-component-record :component="$component" />
                                            @endforeach
                                        </tr>
                                        <tr></tr>
                                    </tbody>
                ...
                <div class="modal-dialog" role="document">
                    <div class="modal-content">
                        <div class="modal-header">
                            <h4 class="modal-title">New Component</h4><button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">×</span></button>
                        </div>
