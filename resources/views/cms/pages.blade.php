                                ...
                                <table class="table my-0" id="dataTable">
                                    ...
                                    <tbody>
                                        <tr>
                                            ...
                                            <x-page-record :page="$page" :user="$user"/>
                                            @endforeach
                                        </tr>
                                        <tr></tr>
                                    </tbody>
            ...
            <div class="modal fade" role="dialog" tabindex="-1" id="new-page-modal">
                <div class="modal-dialog modal-dialog-centered" role="document">
                    <div class="modal-content">
                        ...
                        <form class="user" method="POST" action="/api/page">
                            @csrf
                            <div class="modal-body">
                                <div class="form-group">
                                    <select class="custom-select" name="id_temp" id="id_temp">
                                        @foreach($templates as $template)
                                        <option name="id_cat" value={{$template->id}}>{{$template->name}}</option>
                                        @endforeach
                                    </select>
                                </div>
                                <div class="form-group"><input class="form-control form-control-user" type="text" id="name" aria-describedby="nameHelper" placeholder="Enter page name..." name="name"></div>
                                <div class="form-group"><input class="form-control form-control-user" type="text" id="url" aria-describedby="nameHelper" placeholder="Enter page url..." name="url"></div>
                                <div class="form-group d-none"><input class="" type="text" id="created_by" aria-describedby="nameHelper" placeholder="" name="created_by" value="{{$user->id}}"></div>
