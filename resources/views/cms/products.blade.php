                ...
                <div class="container-fluid">
                    ...
                    <div class="card shadow">
                        ...
                        <div class="card-body">
                                ...
                                <table class="table my-0" id="dataTable">
                                    ...
                                    <tbody>
                                        <tr>
                                            ...
                                            <x-product-record :product="$product" />
                                            @endforeach
                                        </tr>
                                        <tr></tr>
                                    </tbody>
                            ...
                            <div class="row">
                                <div class="col text-right"><button class="btn btn-primary" data-toggle="modal" data-target="#new-product-modal" type="button">Add New</button></div>
                            </div>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="modal-content">
                        ...
                        <form class="user" method="POST" action="/api/product">
                            ...
                            <div class="modal-body">
                                ...
                                <div class="form-group"><input class="form-control form-control-user" type="number" step="0.01" min=0 id="price" aria-describedby="nameHelper" placeholder="Enter product price..." name="price"></div>
